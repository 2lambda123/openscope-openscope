...
ava(
    "aliases, noop parser and zeroArgumentsValidator used by clearedAsFiled",
    (t) => {
...
ava(
    "aliases, noop parser and zeroArgumentsValidator used by flyPresentHeading",
    (t) => {
        const [parse, validate] = extractParseAndValidate(
            t,
            "flyPresentHeading",
        );
        t.true(parse === noopParse() && validate === zeroArgVal());
...
ava(
    "aliases, noop parser and zeroArgumentsValidator used by sayAltitude",
    (t) => {
...
ava(
    "aliases, noop parser and zeroArgumentsValidator used by sayAssignedAltitude",
    (t) => {
        const [parse, validate] = extractParseAndValidate(
            t,
            "sayAssignedAltitude",
...
ava(
    "aliases, noop parser and zeroArgumentsValidator used by sayHeading",
    (t) => {
...
ava(
    "aliases, noop parser and zeroArgumentsValidator used by sayAssignedHeading",
    (t) => {
        const [parse, validate] = extractParseAndValidate(
            t,
            "sayAssignedHeading",
...
ava(
    "aliases, noop parser and zeroArgumentsValidator used by sayIndicatedAirspeed",
    (t) => {
        const [parse, validate] = extractParseAndValidate(
            t,
...
ava(
    "aliases, noop parser and zeroArgumentsValidator used by sayAssignedSpeed",
    (t) => {
        const [parse, validate] = extractParseAndValidate(
            t,
            "sayAssignedSpeed",
...
ava(
    "aliases, noop parser and singleArgumentValidator used by expectArrivalRunway",
    (t) => {
        const [parse, validate] = extractParseAndValidate(
            t,
            "expectArrivalRunway",
...
ava(
    "aliases, noop parser and singleArgumentValidator used by moveDataBlock",
    (t) => {
...
ava(
    "aliases, strToNumArray parser and singleArgumentValidator used by speed",
    (t) => {
...
ava(
    "aliases, noop parser and zeroOrOneArgumentValidator used by cancelHold",
    (t) => {
...
ava(
    "aliases, optionalAltitudeParser and optionalAltitudeValidator used by descendViaStar",
    (t) => {
...
ava(
    "aliases, optionalAltitudeParser and optionalAltitudeValidator used by climbViaSid",
    (t) => {
...
ava("make sure we test all 32 aircraft commands", (t) => {
    t.true(
        Object.values(AIRCRAFT_COMMAND_MAP).filter(
            (val) => !val.isSystemCommand,
        ).length === 32,
    );
});
